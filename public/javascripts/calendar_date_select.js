...
CalendarDateSelect.prototype = {
  ...
  positionCalendarDiv: function(post_painted) {
    ...
    if (post_painted)
    {
      this.iframe = $(document.body).build("iframe", {src: '/blank.html'}, { position:"absolute", left: left_px, top: top_px, height: c_height.toString()+"px", width: c_width.toString()+"px", border: "0px"})
